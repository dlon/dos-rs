...
fn main() -> Result<(), io::Error> {
    use dos::string::{CodePage, from_multibyte};
    ...
    let os_string = from_multibyte(latin1_bytes, CodePage::Windows1252)?;
    ...
    let os_string = from_multibyte(ascii_str, CodePage::UsAscii)?;
    ...
    let os_string = from_multibyte(iso_bytes, CodePage::Iso88591)?;
    ...
    let empty_str = c"";
    let os_string = from_multibyte(empty_str, CodePage::Utf8)?;
